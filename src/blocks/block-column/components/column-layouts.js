...
const columnLayouts = {
  ...
  2: [
    {
      name: __("2 Columns - 50/50", "dggb-blocks"),
      key: "ab-2-col-equal",
      col: 2,
      icon: icons.twoEqual,
    },
    {
      name: __("2 Columns - 75/25", "dggb-blocks"),
      key: "ab-2-col-wideleft",
      col: 2,
      icon: icons.twoLeftWide,
    },
    {
      name: __("2 Columns - 25/75", "dggb-blocks"),
  ...
  3: [
    {
      name: __("3 Columns - 33/33/33", "dggb-blocks"),
      key: "ab-3-col-equal",
      col: 3,
      icon: icons.threeEqual,
    },
    {
      name: __("3 Columns - 25/50/25", "dggb-blocks"),
      key: "ab-3-col-widecenter",
      col: 3,
      icon: icons.threeWideCenter,
    },
    {
      name: __("3 Columns - 50/25/25", "dggb-blocks"),
      key: "ab-3-col-wideleft",
      col: 3,
      icon: icons.threeWideLeft,
    },
    {
      name: __("3 Columns - 25/25/50", "dggb-blocks"),
  ...
  4: [
    {
      name: __("4 Columns - 25/25/25/25", "dggb-blocks"),
      key: "ab-4-col-equal",
      col: 4,
      icon: icons.fourEqual,
    },
    {
      name: __("4 Columns - 40/20/20/20", "dggb-blocks"),
      key: "ab-4-col-wideleft",
      col: 4,
      icon: icons.fourLeft,
    },
    {
      name: __("4 Columns - 20/20/20/40", "dggb-blocks"),
