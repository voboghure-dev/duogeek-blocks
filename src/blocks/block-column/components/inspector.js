...
export default class Inspector extends Component {
  ...
  render() {
    ...
    /* CSS Units */
    const cssUnits = [
      { value: "px", label: __("Pixel (px)", "dggb-blocks") },
      { value: "%", label: __("Percent (%)", "dggb-blocks") },
      { value: "em", label: __("Em (em)", "dggb-blocks") },
    ];
    ...
    return (
      <InspectorControls key="inspector">
        {attributes.layout && (
          ...
          <PanelBody
            title={__("General", "dggb-blocks")}
            initialOpen={true}
            className="dggb-column-select-panel"
          >
            <RenderSettingControl id="dggb_column_columns">
              <RangeControl
                label={__("Column Count", "dggb-blocks")}
                help={__(
            ...
            {(2 === attributes.columns ||
              ...
              <Fragment>
                <RenderSettingControl id="dggb_column_columnLayouts">
                  <p>{__("Column Layout", "dggb-blocks")}</p>
                  <ButtonGroup aria-label={__("Column Layout", "dggb-blocks")}>
                    {map(
                  ...
                  <p>
                    <i>
                      {__("Change the layout of your columns.", "dggb-blocks")}
                    </i>
                  </p>
                  <hr />
                </RenderSettingControl>
            ...
            <RenderSettingControl id="dggb_column_columnsGap">
              <RangeControl
                label={__("Column Gap", "dggb-blocks")}
                help={__("Adjust the spacing between columns.", "dggb-blocks")}
            ...
            <RenderSettingControl id="dggb_column_columnMaxWidth">
              <RangeControl
            ...
            {0 < attributes.columnMaxWidth && (
              <RenderSettingControl id="dggb_column_centerColumns">
                <ToggleControl
                  label={__("Center Columns In Container", "dggb-blocks")}
                  help={__(
            ...
            <RenderSettingControl id="dggb_column_responsiveToggle">
              <ToggleControl
                label={__("Responsive Columns", "dggb-blocks")}
                help={__(
        ...
        <RenderSettingControl id="dggb_column_marginPadding">
          <PanelBody
            title={__("Margin and Padding", "dggb-blocks")}
            initialOpen={false}
          >
            <SelectControl
              label={__("Margin Unit", "dggb-blocks")}
              help={__(
            ...
            />
            <ToggleControl
              label={__("Sync Margin", "dggb-blocks")}
              help={__(
            ...
            {!attributes.marginSync ? (
              ...
              <Margin
                ...
                marginVerticalLabel={__("Margin Top/Bottom", "dggb-blocks")}
            ...
            <hr />
            <SelectControl
              label={__("Padding Unit", "dggb-blocks")}
              help={__(
                "Choose between pixel, percent, or em units.",
                "dggb-blocks"
              )}
            ...
            />
            <ToggleControl
              label={__("Sync Padding", "dggb-blocks")}
              help={__(
        ...
        <RenderSettingControl id="dggb_column_colorSettings">
          <PanelColorSettings
        ...
        <RenderSettingControl id="dggb_column_backgroundImagePanel">
          <BackgroundImagePanel {...this.props}></BackgroundImagePanel>
        </RenderSettingControl>
      </InspectorControls>
    );
  }
