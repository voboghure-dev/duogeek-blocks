...
export default class SocialIcons extends Component {
  ...
  render() {
    return (
      <ul className="dggb-social-links">
        {this.props.attributes.website &&
          !!this.props.attributes.website.length && (
            <li>
              ...
              >
                {__("Website", "dggb-blocks")}{" "}
                <i
                  style={{
                    backgroundColor: this.props.attributes.profileLinkColor,
                  }}
