...
export default class Container extends Component {
  ...
  render() {
    ...
    const className = classnames(
      [this.props.className, "dggb-block-container"],
      {
    ...
    return (
      <div style={styles} className={className ? className : undefined}>
        <div className="dggb-container-inside">
          {containerImgURL && !!containerImgURL.length && (
            <div className="dggb-container-image-wrap">
              <img
                className={classnames(
                  "dggb-container-image",
          ...
          <div
            className="dggb-container-content"
            style={{
