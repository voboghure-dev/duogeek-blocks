  ...
  render() {
    ...
    return (
      <InspectorControls key="inspector">
        <RenderSettingControl id="dggb_column_inner_marginPadding">
          <PanelBody
        ...
        <RenderSettingControl id="dggb_column_inner_colorSettings">
          <PanelColorSettings
        ...
        <RenderSettingControl id="dggb_column_inner_backgroundImagePanel">
