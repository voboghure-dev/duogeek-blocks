...
export default class Column extends Component {
  ...
  render() {
    ...
    if (attributes.customBackgroundColor) {
      backgroundColorClass = "dggb-has-custom-background-color";
    } else {
    ...
    if (attributes.customTextColor) {
      textColorClass = "dggb-has-custom-text-color";
    } else {
    ...
    return (
      <div
        className={classnames(
          ...
          "dggb-block-layout-column",
          attributes.columnVerticalAlignment
            ? "dggb-is-vertically-aligned-" + attributes.columnVerticalAlignment
            : null
        )}
      >
        <div
          className={classnames(
            "dggb-block-layout-column-inner",
