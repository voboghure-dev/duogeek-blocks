...
export default class Inspector extends Component {
  render() {
    ...
    const citeAlignOptions = [
      {
        value: "left-aligned",
        label: __("Left Aligned", "dggb-blocks"),
      },
      {
        value: "right-aligned",
        label: __("Right Aligned", "dggb-blocks"),
      },
    ];
    ...
    return (
      <InspectorControls key="inspector">
        <PanelBody>
          <RenderSettingControl id="dggb_testimonial_testimonialFontSize">
            <RangeControl
          ...
          <RenderSettingControl id="dggb_testimonial_testimonialCiteAlign">
            <SelectControl
              label={__("Cite Alignment", "dggb-blocks")}
              description={__(
        ...
        <RenderSettingControl id="dggb_testimonial_testimonialBackgroundColor">
          <PanelColorSettings
        ...
        <RenderSettingControl id="dggb_testimonial_testimonialTextColor">
          <PanelColorSettings
