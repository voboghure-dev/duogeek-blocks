...
export default class PostGridImage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <div className={classnames("dggb-block-post-grid-image")}>
          <a
          ...
          !this.getImageUrl() &&
            ...
            "selectimage" !== this.props.imgSize && (
              <Fragment>
                <div className={"dggb-post-grid-no-image-icon"}>
                  <Dashicon icon={"warning"} />
                </div>

                <Placeholder className={"dggb-post-grid-no-image-placeholder"}>
                  <Dashicon icon={"info"} />
                  ...
                  <div className="dggb-post-grid-image-help">
                    <a
                      target="_blank"
                      ...
                      href="#featured-image-sizes"
                    >
                      {__("Learn more ", "dggb-blocks")}
                      <span>&rarr;</span>
                    </a>
                  </div>
                </Placeholder>
