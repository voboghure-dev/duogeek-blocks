...
class LatestPostsBlock extends Component {
  render() {
    ...
    if (!hasPosts) {
      return (
        <Fragment>
          ...
          <Placeholder
            icon="admin-post"
            label={__("DuoGeek Blocks Post and Page Grid", "dggb-blocks")}
          >
            {!Array.isArray(latestPosts) ? (
              <Spinner />
            ) : (
              __("No posts found.", "dggb-blocks")
            )}
          </Placeholder>
        </Fragment>
      );
    ...
    const layoutControls = [
      {
        icon: "grid-view",
        title: __("Grid View", "dggb-blocks"),
        onClick: () => setAttributes({ postLayout: "grid" }),
        isActive: "grid" === attributes.postLayout,
      },
      {
        icon: "list-view",
        title: __("List View", "dggb-blocks"),
    ...
    return (
      <Fragment>
        ...
        <SectionTag
          className={classnames(this.props.className, "dggb-block-post-grid")}
        >
          {attributes.displaySectionTitle && attributes.sectionTitle && (
            <SectionTitleTag className="dggb-post-grid-section-title">
          ...
          <div
            className={classnames({
              ...
              "dggb-post-grid-items": "dggb-post-grid-items",
            })}
          >
            {displayPosts.map((post, i) => (
              ...
              >
                ...
                <div className="dggb-block-post-grid-text">
                  <header className="dggb-block-post-grid-header">
                    {attributes.displayPostTitle && (
                      <PostTag className="dggb-block-post-grid-title">
                        <a
                          href={post.link}
                          target="_blank"
                    ...
                    {isPost && (
                      <div className="dggb-block-post-grid-byline">
                        {attributes.displayPostAuthor &&
                          post.author_info.display_name && (
                            <div className="dggb-block-post-grid-author">
                              <a
                                className="dggb-text-link"
                                target="_blank"
                        ...
                        {attributes.displayPostDate && post.date_gmt && (
                          <time
                            dateTime={moment(post.date_gmt)
                              .utc()
                              .format()}
                            className={"dggb-block-post-grid-date"}
                          >
                            {moment(post.date_gmt)
                              .local()
                              .format("MMMM DD, Y", "dggb-blocks")}
                          </time>
                        )}
                      </div>
                    )}
                  ...
                  <div className="dggb-block-post-grid-excerpt">
                    ...
                    {attributes.displayPostLink && (
                      <p>
                        <a
                          className="dggb-block-post-grid-more-link dggb-text-link"
                          href={post.link}
                          target="_blank"
                          rel="bookmark noopener noreferrer"
                        >
