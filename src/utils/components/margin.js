  ...
  return (
    <Fragment>
      {marginEnableTop && (
        <RangeControl
          label={
            marginTopLabel ? marginTopLabel : __("Margin Top", "dggb-blocks")
          }
          value={marginTop}
          min={marginTopMin}
          max={marginTopMax}
      ...
      {marginEnableLeft && (
        <RangeControl
          label={
            marginLeftLabel ? marginLeftLabel : __("Margin Left", "dggb-blocks")
          }
          value={marginLeft}
          min={marginLeftMin}
          max={marginLeftMax}
      ...
      {marginEnableVertical && (
        <RangeControl
          label={
            marginVerticalLabel
              ? marginVerticalLabel
              : __("Margin Vertical", "dggb-blocks")
          }
      ...
      {marginEnableHorizontal && (
        <RangeControl
          label={
            marginHorizontalLabel
              ? marginHorizontalLabel
              : __("Margin Horizontal", "dggb-blocks")
          }
