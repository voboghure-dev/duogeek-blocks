  ...
  render() {
    ...
    if (
      ...
      ("undefined" === typeof this.props.children._owner ||
        "undefined" === typeof this.props.children._owner.memoizedProps ||
        "undefined" === typeof this.props.children._owner.memoizedProps.name)
    ) {
    ...
    if (
      applyFilters(
        "dggb_should_render_block_setting",
        true,
        blockName,
        this.props.id,
        getCurrentUserData()
